...
public class ContentCodeGenerator {
    private static final String SERVICE_NAME = "evaluate";
...
//            "g_apply_position"
    ...
    public static void main(String[] args) {
        ...
        //生成路径
        gc.setOutputDir(System.getProperty("user.dir") + "/evaluate-generator/src/main/java/");
        gc.setAuthor("tan");
        gc.setOpen(false);
